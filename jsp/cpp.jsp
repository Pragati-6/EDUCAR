<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    if(session.getAttribute("username")==null){
    	response.sendRedirect("cpplogin.html");
    }
        ...
        <div class="template-heading">
            ...
            <div class="template-logo">
                ...
                <div class="template-logo-button">
                    <a href="cpplogin.html" id="cpp" class="btn btn-primary">Enroll Now</a>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="https://data-flair.training/blogs/wp-content/uploads/sites/2/2019/06/C-Hello-World-Example.jpg"
                                class="d-block w-100" alt="Syntax of c++">
                        </div>
                        <div class="carousel-item">
                            <img src="https://i.ytimg.com/vi/eXpPo3PTsRo/maxresdefault.jpg" class="d-block w-100"
                                alt="Hello world in C++">
                        </div>
                        <div class="carousel-item">
        ...
        <div class="template-content">
            ...
            <div class="template-content-content">
                ...
                <p class="content">In this course, you are going to learn about, a full introduction into all of the
                    ...
                    comfortable coding in C++ as well! There are practice sets included along with some quizzes just
                    made
                    for you. :)</p>
